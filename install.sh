...
> This file was auto-generated by harness inject. Run \`/init-project\` in Claude Code to auto-detect your tech stack and fill in project-specific details.$FRONTEND_NOTE
